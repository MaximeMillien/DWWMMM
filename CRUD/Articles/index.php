        ...
        <div class="container=fluid">
            <div class="rox">
                <div class="col-md-12">
                    <div class="mt--5 mb-3">
                        <h2>Articles</h2>
                        <a href="create.php" class="btn btn-succes pull-right"><i class="fa fa-plus"></i>New Articles</a>
                    </div>
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo "Oups , pas d'enregistrement trouvé , veuillez réessayez ultérieurement";
                        }
                    } else {
                        echo "Oups , probleme de connexion a la BDD , veuillez réessayez ultérieurement";
